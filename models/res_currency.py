...
class Currency(models.Model):
    ...
    def get_usd_rate(self):
        ...
        headers = {
            ...
            'cookie': 'A88DE7051AB3182EA14B95F6F7724293~000000000000000000000000000000~YAAQVZ42F1BXNW+SAQAA1KEDcRl8jKba'
                      'GiF0HUbAY6YIJFmabpQ7l18zSTZ80FCxhB89BZOdHbhnaD+N2CQkW2SRVwp/zTwmUhuxw9z9Q4ZZl3cskXF3kUEoIgZPpV1y'
                      'lHDx/CLR+VPhQ+7V+KrV6X1BFGEtMWwjZz8/ceMyqYqyjmAm/+Wux+pPziYI+o8W5JMcFNVFZEVCr9Ap9sO6w7WwqO2GbaX2'
                      '4/iDDtgtpSun59F6ynNBlbLlP4uWjj7hlyz5q1hgC3iGbhynKpzQCL+DnRoi+eVha0VDpqatFAmkcG9xiY4J704R76biNsKx'
                      'IK1ZmsFEWvWLKitqhF3i/h6a65mBg1Nom2+9I+4r/tzhglWivTsUWjSyMvPsnpsNFfX/a2Tbo8PMAki3BwQzen03eShsz7J/'
                      'YYA5OINqHQ9SiQ/tDtCXcHGV4wBLx/2/MGFnn3k9Vdilib+IHkThv8I=", "/", ".bangkokbank.com',
            ...
            'sec-ch-ua-full-version-list': '"Google Chrome";v="129.0.6668.90", "Not=A?Brand";v="8.0.0.0", "Chromium";'
                                           'v="129.0.6668.90"',
            'sec-ch-ua-mobile': '?0',
            'sec-ch-ua-model': '""',
